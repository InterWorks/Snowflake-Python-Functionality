...
from ..interworks_snowpark_python.snowpipe_ingest_manager_builder import build_snowpipe_ingest_manager_via_parameters_json as build_snowpipe_ingest_manager
